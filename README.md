...
🎓 **Graduado** em Análise e Desenvolvimento de Sistemas - *Universidade Presbiteriana Mackenzie*

📚 **Cursando** Pós-graduação em Engenharia de Software - *Pontifícia Universidade Católica do Rio de Janeiro (PUC-Rio)*

💡 Tenho **paixão por tecnologia** e **aprendizado contínuo**. Gosto de desenvolver e sou **analítico** por natureza.
...
*Legenda: ✅ = Commits realizados | ❌ = Sem commits*
